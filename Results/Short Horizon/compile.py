...
target_folders = ["Arima","Catboost", "Chronos", "DLinear", "Enc Dec", "ETS", "LightGBM", "LSTM", "Naive","NHiTS", "NVAR", "timegpt", "TSMixer", "XGBoost"]
...
torch.save(map_dict, "short_preds_actuals_all_combined.pt")